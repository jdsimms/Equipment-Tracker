 ...
 */
public class Run_Script_Task extends SwingWorker<String, String> {
    ...
    public Run_Script_Task(Application_Main parentMain, ProgressMonitor progressMonitor) {
...
//                up.setAlwaysOnTop(true);
    ...
    @Override
    public void done(){
        // Refrash the equipment on main display after Update Script is run
